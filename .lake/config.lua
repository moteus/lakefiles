...
lake.define_need('lua51', function()
  assert(ENV.LUA_DIR_5_1 or ENV.LUA_DIR)
  return {
    incdir = J(ENV.LUA_DIR_5_1 or ENV.LUA_DIR, 'include');
    libdir = J(ENV.LUA_DIR_5_1 or ENV.LUA_DIR, 'lib');
    libs = {'lua51'};
  }
end)
